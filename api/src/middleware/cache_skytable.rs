...
use crate::db::common::ctx::{ApiInfo, ReqCtx, UserInfoCtx};
use crate::db::common::res::ResJsonString;
use crate::service::service_utils::ApiUtils::ALL_APIS;
...
pub static INDEX_MAP: Lazy<Arc<Mutex<BTreeMap<String, Instant>>>> = Lazy::new(|| {
    let data: std::collections::btree_map::BTreeMap<String, Instant> = BTreeMap::new();
